import matplotlib
from matplotlib.pyplot import figure,gca,text
...
def draw_2D_vector(x,y,name):
	...
	x2 = 1.15 * x
	y2 = 1.15 * y
	matplotlib.pyplot.text(x2,y2,name,fontsize=16)    
...
def draw_real_part():
	...
	# drawing |0>
	matplotlib.pyplot.plot(1,0,"o")
	matplotlib.pyplot.text(1.05,0.05,"|0>",fontsize=fsize)
	# drawing |1>
	matplotlib.pyplot.plot(0,1,"o")
	matplotlib.pyplot.text(0.05,1.05,"|1>",fontsize=fsize)

def draw_real_part2():
	# draw a figure
	figure(figsize=(6,6), dpi=60)
	points = [ [1.1,0], [0,1.2], [0,-1.2] ] # dummy points for zooming out
	arrows = [ [1.1,0], [0,1.1], [0,-1.1]  ] # coordinates for the axes
	for p in points: 
		matplotlib.pyplot.plot(p[0],p[1]+0.1) # drawing dummy points
	for a in arrows: 
		matplotlib.pyplot.arrow(0,0,a[0],a[1],head_width=0.04, head_length=0.08) # drawing the axes
	...
	# drawing |+>
	matplotlib.pyplot.plot(1,0,"o")
	matplotlib.pyplot.text(1.05,0.1,"$ (|0>+|1>)/\sqrt{2} $",fontsize=fsize)
	# drawing |0>
	matplotlib.pyplot.plot(0,1,"o")
	matplotlib.pyplot.text(0.05,1.1,"|0>",fontsize=fsize)
	# drawing |1>
	matplotlib.pyplot.plot(0,-1,"o")
	matplotlib.pyplot.text(0.05,-1.15,"|1>",fontsize=fsize)
...
def draw_imaginary_part():
	...
	# drawing 1
	matplotlib.pyplot.plot(1,0,"o")
	matplotlib.pyplot.text(1.05,0.05,"1",fontsize=fsize)
	# drawing i
	matplotlib.pyplot.plot(0,1,"o")
	matplotlib.pyplot.text(0.05,1.05,"i",fontsize=fsize)
	# drawing -1
	matplotlib.pyplot.plot(-1,0,"o")
	matplotlib.pyplot.text(-1.2,-0.15,"-1",fontsize=fsize)
	# drawing -i
	matplotlib.pyplot.plot(0,-1,"o")
	matplotlib.pyplot.text(-0.2,-1.15,"-i",fontsize=fsize)
